...
**199 ctest tests** (18 labelled `real-core`; the `IMAS_MVDD_REAL_CORE_TESTS=OFF`
stub-only profile registers 177). None of the C sources here is registered by
...
| `shim/` | 11 C suites driving the public ABI against that stub — 170 tests. |
...
### `write-delete-*` — 34 · `shim/write_delete_conversion_test.c`
