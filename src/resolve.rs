...
//! Four ADRs are enforced in this file, and a change to any of them lands
//! here:
//!
...
//! was the first part, and it took ADR 0001 out of this file; the parts that
//! follow lift the seam policy out of the interposition around it, after which
//! what remains here is renamed. Until they land, this module states what it
//! owns instead of pretending to own less.
